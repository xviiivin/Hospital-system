        ...
        <div class="w-full h-full px-8">
          <div class="mt-5">
            ...
            <div
              ...
              v-for="(val, index) in hosRecord"
              :key="index"
            >
              <router-link
                style="cursor: pointer; text-decoration: none"
                :to="`/symptomrecord/${val.hospitalId}`"
              >
                <div class="rounded-xl group drop-shadow-xl overflow-hidden">
                  <img
                    class="h-full w-full group-hover:scale-110 ease-in duration-300 group-hover:opacity-[80%]"
                    :src="val.image"
                  />
                  <div
                  ...
                  <div class="bottom-3 absolute ml-5">
                    <p
                      class="text-md text-bold text-white group-hover:text-white font-semibold"
                    >
                      {{ val.name }}
                    </p>
                  </div>
