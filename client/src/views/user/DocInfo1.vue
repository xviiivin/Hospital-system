            ...
            <div class="mt-5">
              ...
              <div class="text-[#111727] ml-[20%]">
                <ul class="list-disc marker:text-sky-800 break-words font-semibold">
                  <li>
                    Name <span class="font-light text-[#111727] opacity-[60%] ml-10"> {{ val.docname }} </span>
                  </li>
                  <li>
                    Expert <span class="font-light text-[#111727] opacity-[60%] ml-5"> {{ val.specialist }} </span>
                  </li>
                  <li>
                    Age <span class="font-light text-[#111727] opacity-[60%] ml-12">{{ val.age }}</span>
                  </li>
                  <li>
                    Gender <span class="font-light text-[#111727] opacity-[60%] ml-5">{{ val.gender }}</span>
                  </li>
                  <li>
                    Description <span class="font-light text-[#111727] opacity-[60%] ml-5"> {{ val.description }}</span>
                  </li>
                </ul>
              </div>
            </div>
